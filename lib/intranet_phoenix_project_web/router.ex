defmodule IntranetPhoenixProjectWeb.Router do
  use IntranetPhoenixProjectWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {IntranetPhoenixProjectWeb.Layouts, :root}
  ...
  # scope "/api", IntranetPhoenixProjectWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:intranet_phoenix_project, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: IntranetPhoenixProjectWeb.Telemetry
